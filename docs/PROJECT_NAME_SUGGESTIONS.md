...
- Clear, descriptive
- SEO-friendly
- Matches the core functionality
...
```
Security testing framework focused on attack chain analysis - finding multi-step exploits that automation misses
```

### Medium (README tagline)
```
